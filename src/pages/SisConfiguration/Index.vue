<template>
  <q-page class="q-px-lg q-pt-lg q-pb-none">
    ...
    <sis-configuration-form v-model:show-dialog="showDialogForm"
                             :record-id="recordId"
                             @success="successCreate"></sis-configuration-form>

    <sis-configuration-state v-model:show-dialog="showDialogState"
                              :record-id="recordId"
                              @success="successState"></sis-configuration-state>
  </q-page>
</template>
...
import SisConfigurationState from "pages/SisConfiguration/State.vue";
import SisConfigurationForm from "pages/SisConfiguration/Form.vue";

export default {
  name: 'SisConfigurationIndex',
  components: {SisConfigurationForm, SisConfigurationState, XTableServer},
  setup() {
    const refStoreTableServer = ref();
    let title = 'Listado de configuración sis';
    let resource = 'api/sis_configurations';
