<template>
  <q-page class="q-px-lg q-pt-lg q-pb-none">
    ...
    <mail-configuration-form v-model:show-dialog="showDialogForm"
                             :record-id="recordId"
                             @success="successCreate"></mail-configuration-form>

    <mail-configuration-state v-model:show-dialog="showDialogState"
                              :record-id="recordId"
                              @success="successState"></mail-configuration-state>
  </q-page>
</template>
...
import MailConfigurationState from "pages/MailConfiguration/State.vue";
import MailConfigurationForm from "pages/MailConfiguration/Form.vue";

export default {
  name: 'MailConfigurationIndex',
  components: {MailConfigurationForm, MailConfigurationState, XTableServer},
  setup() {
    const refStoreTableServer = ref();
    let title = 'Listado de configuración mail';
