<template>
  <q-page class="q-px-lg q-pt-lg q-pb-none">
    ...
    <ws-configuration-form v-model:show-dialog="showDialogForm"
                            :record-id="recordId"
                            @success="successCreate"></ws-configuration-form>

    <ws-configuration-state v-model:show-dialog="showDialogState"
                             :record-id="recordId"
                             @success="successState"></ws-configuration-state>
  </q-page>
</template>
...
import WsConfigurationState from "pages/WsConfiguration/State.vue";
import WsConfigurationForm from "pages/WsConfiguration/Form.vue";

export default {
  name: 'WsConfigurationIndex',
  components: {WsConfigurationForm, WsConfigurationState, XTableServer},
  setup() {
    const refStoreTableServer = ref();
    let title = 'Listado de configuración ws';
